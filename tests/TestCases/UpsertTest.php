...
class UpsertTest extends TestCase
{
    public function run()
    {
        ...
        $this->checkQueryResult(r\db('Heroes')->table('marvel')->insert(array( 'superhero' => 'Iron Man', 'superpower' => 'Arc Reactor' ), true), array('unchanged' => 1, 'skipped' => 0, 'replaced' => 0, 'inserted' => 0, 'errors' => 0, 'deleted' => 0));
