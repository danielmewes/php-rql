...
class UpdateTest extends TestCase
{
    public function run()
    {
        ...
        $this->checkQueryResult(r\db('Heroes')->table('marvel')->get('superman')->update( array('age' => 30) ), array('unchanged' => 0, 'skipped' => 0, 'replaced' => 1, 'inserted' => 0, 'errors' => 0, 'deleted' => 0));
        ...
        $this->checkQueryResult(r\db('Heroes')->table('marvel')->update(array( 'age' => r\row('age')->add(r\js('1')) ), true), array('unchanged' => 0, 'skipped' => 0, 'replaced' => 3, 'inserted' => 0, 'errors' => 0, 'deleted' => 0));
