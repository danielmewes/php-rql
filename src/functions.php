...
function tableCreate($tableName, $options = [])
{
...
function expr($obj)
{
    return ($obj instanceof Query) ? $obj : (new DatumConverter())->nativeToDatum($obj);
}
...
function random($left = null, $right = null, array $opts = [])
{
...
function iso8601($iso8601Date, $opts = [])
{
...
function circle($center, $radius, array $opts = [])
{
...
function distance($g1, $g2, array $opts = [])
{
...
function union($sequence, $otherSequence, array $opts = [])
{
