...
abstract class ValuedQuery extends Query
{
    ...
    public function update($delta, $opts = [])
    {
    ...
    public function replace($delta, $opts = [])
    {
        return new Replace($this, $delta, $opts);
    }

    public function between($leftBound, $rightBound, $opts = [])
    {
    ...
    public function eqJoin($attribute, ValuedQuery $otherSequence, $opts = [])
    {
     ...
     *
     * ```php
     * r\table('posts')->orderBy(['index' => 'date'])->run($conn);
     * ```
     *
     ...
     * <code>
     *
     *  r\table('posts')->orderBy(['index' => r\desc('date')])->run($conn);
     *
     * </code>
     *
     * @param $keys
    ...
    public function slice($startIndex, $endIndex = null, $opts = [])
    {
    ...
    public function union(ValuedQuery $otherSequence, $opts = [])
    {
    ...
    public function fold($base, $fun, $opts = [])
    {
    ...
    public function during($startTime, $endTime, $opts = [])
    {
    ...
    public function distance($g2, $opts = [])
    {
