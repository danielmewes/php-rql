...
class Handshake
{
    ...
    {
        if (0 == $this->state) {
            null == $response or die('Illegal handshake state');
            ...
            if (0 === strpos($response, 'ERROR')) {
                throw new RqlDriverError('Received an unexpected reply. You may be attempting to connect to '.'a RethinkDB server that is too old for this driver. The minimum '.'supported server version is 2.3.0.');
            }
